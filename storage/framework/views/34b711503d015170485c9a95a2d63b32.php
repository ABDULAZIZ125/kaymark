...
<a href="<?php echo e(route('profile.edit')); ?>">
        ...
        <nav class="nav-menu">
            ...
            <ul class="nav flex flex-col space-y-2">
                ...
                <!-- Dashboard -->
                <li class="nav-item">
                    <a href="<?php echo e(route('dashboard.seller')); ?>" class="nav-link tooltip" data-tooltip="Dashboard">
                ...
                <!-- Account Settings -->
                <li class="nav-item">
                    <a href="<?php echo e(route('profile.edit')); ?>" class="nav-link tooltip" data-tooltip="Account Settings">
                ...
                <!-- Submit a Listing -->
                <li class="nav-item">
                    <a href="<?php echo e(route('seller.listings.create')); ?>" class="nav-link tooltip"
                ...
                <!-- My Listings -->
                <li class="nav-item">
                    <a href="<?php echo e(route('seller.listings.index')); ?>" class="nav-link tooltip" data-tooltip="My Listings">
                ...
                <!-- Auctions -->
                <li class="nav-item">
                    <a href="<?php echo e(route('seller.Auction.index')); ?>" class="nav-link tooltip" data-tooltip="Auctions">
                ...
                <!-- Messaging Center -->
                <li class="nav-item">
                    <a href="<?php echo e(route('seller.chat')); ?>" class="nav-link tooltip" data-tooltip="Messages">
...
<?php /**PATH /home/u898351377/domains/360webcoders.com/public_html/kaymark/resources/views/partials/Sellersidebar.blade.php ENDPATH**/ ?>