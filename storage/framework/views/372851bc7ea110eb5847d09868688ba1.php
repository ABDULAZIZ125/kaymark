        ...
        <div class="flex justify-between items-center mb-8 animate-fade-in">
            ...
            <div class="flex items-center space-x-4">
                ...
                <div class="text-sm text-gray-500">
                    <span x-show="!isLoading"><?php echo e($listings->total()); ?> results</span>
            ...
            <aside class="w-full lg:w-1/4 mb-8 lg:mb-0">
                <div class="bg-white rounded-xl shadow-lg p-6 sticky top-4 transition-all duration-300 hover:shadow-xl">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <a href="<?php echo e(route('marketplace.index')); ?>" class="text-indigo-600 text-sm font-medium hover:underline transition-colors">Clear all</a>
                    </div>

                    <form id="filtersForm" method="GET" action="<?php echo e(route('marketplace.index')); ?>" class="space-y-6 max-h-[70vh] overflow-y-auto filter-scroll pr-2">
                        <!-- Type -->
                        <div class="filter-section">
                            ...
                            <div class="space-y-2 max-h-40 overflow-y-auto filter-scroll">
                                <?php $__currentLoopData = $filterOptions['types']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="flex items-center mb-2 group">
                                        <input class="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500 transition-all group-hover:scale-110"
                                               type="checkbox" name="type[]" value="<?php echo e($type); ?>"
                                               id="type_<?php echo e(\Illuminate\Support\Str::slug($type)); ?>"
                                               <?php echo e(in_array($type, (array) request('type', [])) ? 'checked' : ''); ?>>
                                        <label for="type_<?php echo e(\Illuminate\Support\Str::slug($type)); ?>"
                        ...
                        <div class="filter-section">
                            ...
                            <div id="makesList" class="max-h-40 overflow-y-auto filter-scroll space-y-2">
                                <?php $__currentLoopData = $filterOptions['makes']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $make): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="flex items-center mb-2 group">
                                        <input class="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500 transition-all group-hover:scale-110"
                                               type="checkbox" name="makes[]" value="<?php echo e($make); ?>"
                                               id="make_<?php echo e(\Illuminate\Support\Str::slug($make)); ?>"
                                               <?php echo e(in_array($make, (array) request('makes', [])) ? 'checked' : ''); ?>>
                                        <label for="make_<?php echo e(\Illuminate\Support\Str::slug($make)); ?>"
                                               class="ml-2 text-gray-700 text-sm group-hover:text-gray-900 transition-colors cursor-pointer">
                                            <?php echo e($make); ?>
                        ...
                        <div class="filter-section">
                            ...
                            <div id="modelsList" class="max-h-40 overflow-y-auto filter-scroll space-y-2">
                                <?php $__currentLoopData = $filterOptions['models']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $model): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="flex items-center mb-2 group">
                                        <input class="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500 transition-all group-hover:scale-110"
                                               type="checkbox" name="models[]" value="<?php echo e($model); ?>"
                                               id="model_<?php echo e(\Illuminate\Support\Str::slug($model)); ?>"
                                               <?php echo e(in_array($model, (array) request('models', [])) ? 'checked' : ''); ?>>
                                        <label for="model_<?php echo e(\Illuminate\Support\Str::slug($model)); ?>"
                                               class="ml-2 text-gray-700 text-sm group-hover:text-gray-900 transition-colors cursor-pointer">
                                            <?php echo e($model); ?>
                        ...
                        <div class="filter-section">
                            ...
                            <div id="locationsList" class="max-h-40 overflow-y-auto filter-scroll space-y-2">
                                <?php $__currentLoopData = $filterOptions['locations']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $loc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="flex items-center mb-2 group">
                                        <input class="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500 transition-all group-hover:scale-110"
                                               type="checkbox" name="locations[]" value="<?php echo e($loc); ?>"
                                               id="loc_<?php echo e(\Illuminate\Support\Str::slug($loc)); ?>"
                                               <?php echo e(in_array($loc, (array) request('locations', [])) ? 'checked' : ''); ?>>
                                        <label for="loc_<?php echo e(\Illuminate\Support\Str::slug($loc)); ?>"
                                               class="ml-2 text-gray-700 text-sm group-hover:text-gray-900 transition-colors cursor-pointer">
                                            <?php echo e($loc); ?>
                        ...
                        <div class="filter-section">
                            ...
                            <div class="flex space-x-3">
                                <input type="number" name="year_from"
                                    ...
                                    placeholder="From (YYYY)" value="<?php echo e(request('year_from')); ?>">
                                <input type="number" name="year_to"
                                    class="w-1/2 px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all"
                                    placeholder="To (YYYY)" value="<?php echo e(request('year_to')); ?>">
                            </div>
                        </div>
                        ...
                        <div class="filter-section">
                            ...
                            <div class="flex space-x-3 mb-3">
                                <input type="number" id="odoMinInput" name="odo_min"
                                    class="w-1/2 px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all"
                                    placeholder="Min" value="<?php echo e(request('odo_min', 0)); ?>">
                                <input type="number" id="odoMaxInput" name="odo_max"
                                    class="w-1/2 px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all"
                                    placeholder="Max" value="<?php echo e(request('odo_max', 200000)); ?>">
                            </div>
                            <div class="space-y-2">
                                <input type="range" id="odoMinRange" min="0" max="400000" step="100"
                                    ...
                                    value="<?php echo e(request('odo_min', 0)); ?>">
                                <input type="range" id="odoMaxRange" min="0" max="400000" step="100"
                                    class="w-full h-2 bg-indigo-100 rounded-lg appearance-none cursor-pointer"
                                    value="<?php echo e(request('odo_max', 200000)); ?>">
                            </div>
                        </div>
                        ...
                        <div class="filter-section">
                            ...
                            <div class="flex flex-wrap gap-2">
                                <?php $__currentLoopData = $filterOptions['colors']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="flex items-center group">
                                        <input class="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500 transition-all group-hover:scale-110"
                                               type="checkbox" name="colors[]" value="<?php echo e($color); ?>"
                                               id="color_<?php echo e(\Illuminate\Support\Str::slug($color)); ?>"
                                               <?php echo e(in_array($color, (array) request('colors', [])) ? 'checked' : ''); ?>>
                                        <label for="color_<?php echo e(\Illuminate\Support\Str::slug($color)); ?>"
                        ...
                        <div class="filter-section">
                            ...
                            <div class="space-y-2 max-h-40 overflow-y-auto filter-scroll">
                                <?php $__currentLoopData = $filterOptions['primary_damage']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="flex items-center group">
                                        <input class="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500 transition-all group-hover:scale-110"
                                               type="checkbox" name="primary_damage[]" value="<?php echo e($pd); ?>"
                                               id="pd_<?php echo e(\Illuminate\Support\Str::slug($pd)); ?>"
                                               <?php echo e(in_array($pd, (array) request('primary_damage', [])) ? 'checked' : ''); ?>>
                                        <label for="pd_<?php echo e(\Illuminate\Support\Str::slug($pd)); ?>"
                                               class="ml-2 text-gray-700 text-sm group-hover:text-gray-900 transition-colors cursor-pointer">
                                            <?php echo e($pd); ?>
                        ...
                        <div class="filter-section">
                            ...
                            <div class="space-y-2 max-h-40 overflow-y-auto filter-scroll">
                                <?php $__currentLoopData = $filterOptions['secondary_damage']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="flex items-center group">
                                        <input class="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500 transition-all group-hover:scale-110"
                                               type="checkbox" name="secondary_damage[]" value="<?php echo e($sd); ?>"
                                               id="sd_<?php echo e(\Illuminate\Support\Str::slug($sd)); ?>"
                                               <?php echo e(in_array($sd, (array) request('secondary_damage', [])) ? 'checked' : ''); ?>>
                                        <label for="sd_<?php echo e(\Illuminate\Support\Str::slug($sd)); ?>"
                                               class="ml-2 text-gray-700 text-sm group-hover:text-gray-900 transition-colors cursor-pointer">
                                            <?php echo e($sd); ?>
                        ...
                        <div class="filter-section">
                            ...
                            <div class="flex flex-wrap gap-2">
                                <?php $__currentLoopData = $filterOptions['transmission']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="flex items-center group">
                                        <input class="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500 transition-all group-hover:scale-110"
                                               type="checkbox" name="transmission[]" value="<?php echo e($t); ?>"
                                               id="trans_<?php echo e(\Illuminate\Support\Str::slug($t)); ?>"
                                               <?php echo e(in_array($t, (array) request('transmission', [])) ? 'checked' : ''); ?>>
                                        <label for="trans_<?php echo e(\Illuminate\Support\Str::slug($t)); ?>"
                                               class="ml-1 text-gray-700 text-sm group-hover:text-gray-900 transition-colors cursor-pointer">
                                            <?php echo e($t); ?>
                        ...
                        <div class="filter-section">
                            ...
                            <div class="space-y-2 max-h-40 overflow-y-auto filter-scroll">
                                <?php $__currentLoopData = $filterOptions['title_status']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ts): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="flex items-center group">
                                        <input class="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500 transition-all group-hover:scale-110"
                                               type="checkbox" name="title_condition[]" value="<?php echo e($ts); ?>"
                                               id="ts_<?php echo e(\Illuminate\Support\Str::slug($ts)); ?>"
                                               <?php echo e(in_array($ts, (array) request('title_condition', [])) ? 'checked' : ''); ?>>
                                        <label for="ts_<?php echo e(\Illuminate\Support\Str::slug($ts)); ?>"
                                               class="ml-2 text-gray-700 text-sm group-hover:text-gray-900 transition-colors cursor-pointer">
                                            <?php echo e($ts); ?>
            ...
            <main class="w-full lg:w-3/4" x-data="{ open: false, selected: {} }">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $listings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $listing): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="vehicle-card bg-white rounded-xl shadow-lg overflow-hidden flex flex-col h-full animate-zoom-in">
                            <div class="image-container relative">
                                ...
                                ?>
                                <img src="<?php echo e($imgUrl); ?>" alt="listing image" class="w-full h-48 object-cover transition-transform duration-300 hover:scale-105">

                                <!-- Image Overlay -->
                                <div class="image-overlay">
                                    <a href="<?php echo e(route('listing.show', $listing->id)); ?>"
                            ...
                            <div class="p-4 flex-1 flex flex-col">
                                <h5 class="text-lg font-bold text-gray-900 mb-1 line-clamp-1"><?php echo e($listing->make); ?> <?php echo e($listing->model); ?></h5>
                                <p class="text-sm text-gray-500 mb-3"><?php echo e($listing->year); ?> • <?php echo e($listing->location ?? '—'); ?></p>
                                ...
                                <div class="grid grid-cols-2 gap-2 mb-4 text-sm text-gray-600">
                                    <div class="flex items-center">
                                        ...
                                        <span><?php echo e($listing->odometer ? number_format($listing->odometer) . ' km' : 'N/A'); ?></span>
                                    </div>
                                    <div class="flex items-center">
                                        <i class="fas fa-palette text-gray-400 text-xs mr-1"></i>
                                        <span class="truncate"><?php echo e($listing->color ?? 'N/A'); ?></span>
                                    </div>
                                    <div class="flex items-center">
                                        <i class="fas fa-cog text-gray-400 text-xs mr-1"></i>
                                        <span class="truncate"><?php echo e($listing->transmission ?? 'N/A'); ?></span>
                                    </div>
                                    <div class="flex items-center">
                                        <i class="fas fa-file-alt text-gray-400 text-xs mr-1"></i>
                                        <span class="truncate"><?php echo e($listing->title_status ?? 'N/A'); ?></span>
                                    </div>
                                </div>
                                ...
                                <?php if($listing->price): ?>
                                    <div class="mt-auto pt-3 border-t border-gray-200">
                                        ...
                                        <p class="text-xl font-bold text-green-600 price-tag">
                                            $<?php echo e(number_format($listing->price)); ?>
                        ...
                        <div class="vehicle-card bg-white rounded-xl shadow-lg overflow-hidden flex flex-col md:flex-row animate-slide-in">
                            <div class="md:w-2/5 image-container">
                                <?php
                                    ...
                                    $imgUrl = $img
                                        ...
                                        : asset('images/placeholder-car.png');
                                ?>
                                <img src="<?php echo e($imgUrl); ?>" alt="listing image" class="w-full h-64 md:h-full object-cover transition-transform duration-300 hover:scale-105">
                            ...
                            <div class="p-6 flex-1 flex flex-col">
                                <div class="flex justify-between items-start mb-2">
                                    <h5 class="text-xl font-bold text-gray-900"><?php echo e($listing->make); ?> <?php echo e($listing->model); ?> <?php echo e($listing->year); ?></h5>
                                ...
                                <p class="text-gray-500 mb-4"><?php echo e($listing->location ?? '—'); ?></p>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm font-medium"><?php echo e($listing->odometer ? number_format($listing->odometer) . ' km' : 'N/A'); ?></p>
                                        </div>
                                    </div>
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm font-medium"><?php echo e($listing->color ?? 'N/A'); ?></p>
                                        </div>
                                    </div>
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm font-medium"><?php echo e($listing->transmission ?? 'N/A'); ?></p>
                                        </div>
                                    </div>
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm font-medium"><?php echo e($listing->title_status ?? 'N/A'); ?></p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mt-2 grid grid-cols-1 md:grid-cols-2 gap-2 text-sm text-gray-600">
                                    <?php if($listing->primary_damage): ?>
                                        <div class="flex">
                                            <span class="font-medium mr-1">Primary Damage:</span>
                                            <span><?php echo e($listing->primary_damage); ?></span>
                                        </div>
                                    <?php endif; ?>
                                    <?php if($listing->secondary_damage): ?>
                                        <div class="flex">
                                            <span class="font-medium mr-1">Secondary Damage:</span>
                                            <span><?php echo e($listing->secondary_damage); ?></span>
                                        </div>
                                    <?php endif; ?>
                                    <?php if($listing->fuel_type): ?>
                                        <div class="flex">
                                            <span class="font-medium mr-1">Fuel Type:</span>
                                            <span><?php echo e($listing->fuel_type); ?></span>
                                        </div>
                                    <?php endif; ?>
                                    <?php if($listing->engine): ?>
                                        <div class="flex">
                                            <span class="font-medium mr-1">Engine:</span>
                                            <span><?php echo e($listing->engine); ?></span>
                                        </div>
                                    <?php endif; ?>
                                </div>
                                ...
                                <div class="mt-auto pt-4 border-t border-gray-200 flex flex-col md:flex-row md:items-center justify-between">
                                    <div>
                                        ...
                                        <p class="text-2xl font-bold text-green-600 price-tag">
                                            $<?php echo e(number_format($listing->price ?? 0)); ?>
                ...
                <?php if($listings->hasPages()): ?>
                    <div class="mt-8 flex justify-center animate-fade-in">
                        <?php echo e($listings->links('pagination::tailwind')); ?>
...
<?php echo $__env->make('layouts.welcome', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u898351377/domains/360webcoders.com/public_html/kaymark/resources/views/marketplace.blade.php ENDPATH**/ ?>