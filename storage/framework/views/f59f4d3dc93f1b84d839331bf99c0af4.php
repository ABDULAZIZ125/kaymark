<?php $__env->startSection('content'); ?>
    ...
    <body class="min-h-screen bg-gray-50">
        ...
        <main class="max-w-7xl mx-auto px-4 py-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8" x-data="{ showModal: false, currentIndex: 0, images: <?php echo e($listing->images->toJson()); ?> }"
                ...
                <div class="lg:col-span-2">
                        ...
                        <?php if($listing->images->count()): ?>
                            <div class="image-gallery p-4 grid grid-cols-2 md:grid-cols-3 gap-4">
                                ...
                                <div class="col-span-2 md:col-span-3 rounded-lg overflow-hidden">
                                    <img src="<?php echo e(asset('uploads/listings/' . $listing->images[0]->image_path)); ?>"
                                        alt="Main listing image" class="w-full h-80 object-cover rounded-lg cursor-pointer"
                                        @click="showModal = true; currentIndex = 0">
                                </div>

                                
                                <?php $__currentLoopData = $listing->images->slice(1, 4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="rounded-lg overflow-hidden">
                                        <img src="<?php echo e(asset('uploads/listings/' . $image->image_path)); ?>" alt="Listing image"
                                            class="w-full h-40 object-cover rounded-lg cursor-pointer"
                                            @click="showModal = true; currentIndex = <?php echo e($index + 1); ?>">
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>

                            
                            <?php if($listing->images->count() > 5): ?>
                                <div class="px-4 pb-4 text-center">
                                    <button
                                        class="text-primary hover:text-secondary font-medium flex items-center justify-center mx-auto"
                                        @click="showModal = true; currentIndex = 0">
                                        <i class="fas fa-images mr-2"></i>
                                        View All <?php echo e($listing->images->count()); ?> Photos
                                    </button>
                                </div>
                            <?php endif; ?>
                        <?php else: ?>
                    ...
                    <div class="bg-white rounded-xl shadow-md p-6 mb-6 info-card">
                        ...
                        <p class="text-gray-700 leading-relaxed"><?php echo e($listing->description); ?></p>
                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="mt-2 space-y-2">
                                        <div class="flex justify-between">
                                            ...
                                            <span class="font-medium"><?php echo e($listing->year); ?></span>
                                        </div>
                                        <div class="flex justify-between">
                                            <span class="text-gray-600">Make & Model</span>
                                            <span class="font-medium"><?php echo e($listing->make); ?> <?php echo e($listing->model); ?></span>
                                        </div>
                                        <div class="flex justify-between">
                                            <span class="text-gray-600">Trim</span>
                                            <span class="font-medium"><?php echo e($listing->trim); ?></span>
                                        </div>
                                        <div class="flex justify-between">
                                            <span class="text-gray-600">Color</span>
                                            <span class="font-medium"><?php echo e($listing->color); ?></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="mt-2 space-y-2">
                                        <div class="flex justify-between">
                                            ...
                                            <span class="font-medium"><?php echo e($listing->fuel_type); ?></span>
                                        </div>
                                        <div class="flex justify-between">
                                            <span class="text-gray-600">Transmission</span>
                                            <span class="font-medium"><?php echo e($listing->transmission); ?></span>
                                        </div>
                                        <div class="flex justify-between">
                                            <span class="text-gray-600">Engine Type</span>
                                            <span class="font-medium"><?php echo e($listing->engine_type); ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div>
                                    ...
                                    <div class="mt-2 space-y-2">
                                        <div class="flex justify-between">
                                            ...
                                            <span class="font-medium"><?php echo e($listing->condition); ?></span>
                                        </div>
                                        <div class="flex justify-between">
                                            <span class="text-gray-600">Title Status</span>
                                            <span class="font-medium"><?php echo e($listing->title_status); ?></span>
                                        </div>
                                        <div class="flex justify-between">
                                            <span class="text-gray-600">Primary Damage</span>
                                            <span class="font-medium"><?php echo e($listing->primary_damage); ?></span>
                                        </div>
                                        <div class="flex justify-between">
                                            <span class="text-gray-600">Keys Available</span>
                                            <span class="font-medium flex items-center">
                                                <?php if($listing->keys_available == 1): ?>
                                ...
                                <div>
                                    ...
                                    <div class="mt-2 space-y-2">
                                        <div class="flex justify-between">
                                            ...
                                            <span class="font-medium"><?php echo e($listing->listing_method); ?></span>
                                        </div>
                                        <div class="flex justify-between">
                                            <span class="text-gray-600">Category</span>
                                            <span class="font-medium"><?php echo e($listing->major_category); ?> /
                                                <?php echo e($listing->subcategory); ?></span>
                                        </div>
                                        <div class="flex justify-between">
                                            <span class="text-gray-600">Location</span>
                                            <span class="font-medium"><?php echo e($listing->location); ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="sticky-details">
                        ...
                        <div class="bg-white rounded-xl shadow-md p-6 mb-6">
                            <div class="flex justify-between items-start mb-4">
                                <div>
                                    <h2 class="text-3xl font-bold text-dark">$<?php echo e(number_format($listing->price, 2)); ?></h2>
                                    <p class="text-gray-500">Current Price</p>
                                </div>
                                <?php if($listing->listing_method === 'auction'): ?>
...
document.getElementById('buy-now-btn').addEventListener('click', function () {
    fetch("<?php echo e(route('listing.buy', $listing->id)); ?>", {
        method: "POST",
        headers: {
    ...
    .catch(err => {
        ...
        alert("⚠️ Something went wrong while starting checkout. Check console for details.");
                                    ...
                                    <!-- Add to Watchlist -->
                                    <form method="POST" action="<?php echo e(route('listing.watchlist', $listing->id)); ?>"
                                        class="w-full mt-2">
                                        <?php echo csrf_field(); ?>
                                        <button type="submit"
                                            ...
                                            <i
                                                class="fas fa-heart mr-2 <?php echo e(auth()->user()->watchlist()->where('listing_id', $listing->id)->exists() ? 'text-red-500' : ''); ?>"></i>
                                            <?php echo e(auth()->user()->watchlist()->where('listing_id', $listing->id)->exists() ? 'Remove from Watchlist' : 'Add to Watchlist'); ?>
        ...
        <section class="mt-12">
            <div class="max-w-6xl mx-auto"> <!-- Center container with max width -->
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <?php $__empty_1 = true; $__currentLoopData = $similarListings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $similar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="bg-white rounded-xl shadow-md overflow-hidden related-card">
                            <!-- Image -->
                            <div class="h-48 w-full bg-gray-200 relative">
                                <?php if($similar->images->count()): ?>
                                    <img src="<?php echo e(asset('uploads/listings/' . $similar->images[0]->image_path)); ?>"
                                        alt="<?php echo e($similar->title); ?>" class="w-full h-48 object-cover">
                                <?php else: ?>
                            ...
                            <!-- Info -->
                            <div class="p-4">
                                <h3 class="font-bold text-lg mb-1"><?php echo e($similar->make); ?> <?php echo e($similar->model); ?></h3>
                                <p class="text-gray-500 text-sm mb-3">
                                    <?php echo e($similar->body_type ?? 'N/A'); ?> |
                                    <?php echo e(number_format($similar->mileage ?? 0)); ?> miles
                                </p>

                                <div class="flex justify-between items-center">
                                    <span class="font-bold text-xl">$<?php echo e(number_format($similar->price, 0)); ?></span>
...
<?php echo $__env->make('layouts.welcome', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u898351377/domains/360webcoders.com/public_html/kaymark/resources/views/showDetail.blade.php ENDPATH**/ ?>