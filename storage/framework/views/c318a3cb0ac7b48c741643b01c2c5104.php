...
<?php $__env->startSection('title', 'Login - CayMark'); ?>
<head>
    <meta charset="UTF-8">
                ...
                <div class="max-w-md mx-auto">
                    ...
                    <form method="POST" action="<?php echo e(route('login')); ?>" novalidate>
                        ...
                        <div class="input-group">
                            <input id="email" type="email" name="email" required class="input-field" placeholder="Email address" value="<?php echo e(old('email')); ?>" />
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="flex items-center justify-between mb-6">
                            ...
                            <?php if(Route::has('password.request')): ?>
                                <a class="text-sm text-blue-500 hover:text-blue-700 font-medium transition duration-150 ease-in-out" href="<?php echo e(route('password.request')); ?>">
                                    Forgot password?
                                </a>
                            <?php endif; ?>
                        </div>
...
<?php echo $__env->make('layouts.welcome', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u898351377/domains/360webcoders.com/public_html/kaymark/resources/views/auth/login.blade.php ENDPATH**/ ?>