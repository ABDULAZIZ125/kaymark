        ...
        <div class="main-content">
            ...
            <div class="dashboard-cards">
                <div class="card fade-in" style="animation-delay: 0.1s;">
                    ...
                    <div class="card-value"><?php echo e($totalListings); ?></div>
                    <div class="card-growth growth-up">
                        <i class="fas fa-arrow-up"></i>
                        <span><?php echo e($percentageChange); ?>% from last month</span>
                    </div>
                </div>
                ...
                <div class="card fade-in" style="animation-delay: 0.2s;">
                    ...
                    <div class="card-value"><?php echo e($pendingListings); ?></div>
                ...
                <div class="card fade-in" style="animation-delay: 0.3s;">
                    ...
                    <div class="card-value"><?php echo e($approvedListings); ?></div>
                    <div class="card-growth growth-up">
                        <i class="fas fa-arrow-up"></i>
                ...
                <div class="card fade-in" style="animation-delay: 0.4s;">
                    ...
                    <div class="card-value"><?php echo e($rejectedListings); ?></div>
                    <div class="card-growth growth-down">
                        <i class="fas fa-arrow-down"></i>
            ...
            <div class="table-container fade-in" style="animation-delay: 0.5s;">
                <div class="table-header">
                    ...
                    <div class="table-filters">
                        ...
                        <a href="<?php echo e(route('admin.show.listing', ['status' => 'pending'])); ?>"
                            class="filter-btn <?php echo e(request('status') == 'pending' ? 'active' : ''); ?>">
                            Pending
                        </a>
                        <a href="<?php echo e(route('admin.show.listing', ['status' => 'approved'])); ?>"
                            class="filter-btn <?php echo e(request('status') == 'approved' ? 'active' : ''); ?>">
                            Approved
                        </a>
                        <a href="<?php echo e(route('admin.show.listing', ['status' => 'rejected'])); ?>"
                            class="filter-btn <?php echo e(request('status') == 'rejected' ? 'active' : ''); ?>">
                            Rejected
                        </a>
                    </div>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $listings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $listing): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><?php echo e($listing->listing_method); ?></td>
                                <td><?php echo e($listing->listing_type); ?></td>
                                <td>
                                ...
                                <td class="action-buttons">
                                    <?php if($listing->status === 'pending'): ?>
                                        <form action="<?php echo e(route('admin.listing.approve', $listing->id)); ?>" method="POST"
                                        ...
                                        <form action="<?php echo e(route('admin.listing.disapprove', $listing->id)); ?>" method="POST"
                                            style="display:inline;">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('PUT'); ?>
                ...
                <div class="pagination">
                    <?php echo e($listings->links('pagination::bootstrap-5')); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u898351377/domains/360webcoders.com/public_html/kaymark/resources/views/admin/lisitng.blade.php ENDPATH**/ ?>