    ...
    <div class="bg-white p-5 rounded-xl shadow-sm border border-gray-100 mb-8">
        <form method="GET" action="" class="flex flex-col md:flex-row gap-4 items-center">
            ...
            <select name="category" class="px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-DEFAULT focus:border-transparent">
                ...
                <option value="home" <?php echo e(request('category') == 'home' ? 'selected' : ''); ?>>Home & Garden</option>
        ...
        <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-100 flex flex-col h-full">
                ...
                <div class="relative">
                    ...
                    <span class="absolute top-3 right-3 bg-<?php echo e($status['color']); ?>-600 text-white text-xs font-semibold px-3 py-1 rounded-full shadow-md">
                    ...
                    <div class="absolute bottom-0 left-0 right-0 bg-black bg-opacity-40 text-white p-2 text-xs">
                        <div class="flex justify-between mb-1">
                            <span>In Stock</span>
                            <span><?php echo e($product->stock_quantity); ?> available</span>
                        </div>
                        <div class="w-full bg-gray-200 rounded-full h-1.5">
                            ...
                            ?>
                            <div class="bg-<?php echo e($stockColor); ?>-500 h-1.5 rounded-full" style="width: <?php echo e($stockPercentage); ?>%"></div>
                        </div>
                    </div>
                    <?php endif; ?>
                </div>
                ...
                <div class="p-5 flex-grow">
                    ...
                    <div class="flex items-center text-sm text-gray-600 mb-3">
                        ...
                        <span>Added: <?php echo e($product->created_at->format('M d, Y')); ?></span>
                    </div>
                    ...
                    <div class="flex items-center text-sm text-gray-600 mb-3">
                        ...
                        <span class="mr-3 capitalize"><?php echo e($product->category); ?></span>
                        <span class="text-xs bg-gray-100 px-2 py-1 rounded">SKU: <?php echo e($product->sku); ?></span>
                    </div>
                    ...
                    <div class="mb-4 p-3 bg-gray-50 rounded-lg">
                        <div class="flex justify-between items-center mb-1">
                            ...
                            <span class="text-lg font-bold text-primary-DEFAULT">$<?php echo e(number_format($product->price, 2)); ?></span>
                        </div>
                        <div class="text-xs text-gray-500">
                            <?php echo e($product->sold_count); ?> <?php echo e(Str::plural('sale', $product->sold_count)); ?> •
                            $<?php echo e(number_format($product->sold_count * $product->price, 2)); ?> revenue
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.Seller', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u898351377/domains/360webcoders.com/public_html/kaymark/resources/views/Seller/Listing/index.blade.php ENDPATH**/ ?>