    ...
    <section class="py-20 bg-gradient-to-b from-gray-50 to-white mt-16 pt-24">
        <div class="container mx-auto px-4">
            <div class="flex flex-col md:flex-row justify-between items-center mb-12">
                ...
                <a href="<?php echo e(route('Auction.index')); ?>" class="mt-4 md:mt-0 inline-flex items-center text-blue-600 hover:text-blue-800 font-medium transition-colors duration-300 group">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <?php $__empty_1 = true; $__currentLoopData = $auctionListings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $auction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
...
<div class="h-48 overflow-hidden relative group">
    ...
    <div class="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                        ...
                        <div class="p-6">
                            ...
                            <h3 class="text-xl font-bold text-gray-800 mb-2 group-hover:text-blue-700 transition-colors"><?php echo e($auction->title ?? $auction->make . ' ' . $auction->model); ?></h3>
                            <p class="text-gray-600 mb-4 line-clamp-2"><?php echo e($auction->description ?? 'Virtual Auction Lane, multiple vehicles available'); ?></p>
                            ...
                            <a href="<?php echo e(route('auction.show', $auction->id)); ?>"
    ...
    <section class="py-16 bg-gradient-to-b from-white to-gray-50">
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
                <?php $__empty_1 = true; $__currentLoopData = $buyNowItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $listing): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="bg-white rounded-2xl shadow-lg overflow-hidden card-hover border border-gray-100 group">
                        <div class="relative overflow-hidden">
                        ...
                        <div class="p-6">
                            <h3 class="text-xl font-bold text-gray-800 mb-2 group-hover:text-blue-700 transition-colors"><?php echo e($listing->make); ?> <?php echo e($listing->model); ?></h3>
                            <p class="text-gray-600 mb-4 line-clamp-2"><?php echo e($listing->description ?? 'Well-maintained vehicle ready for immediate purchase'); ?></p>
                            <div class="flex justify-between items-center mb-6">
                                <span class="text-2xl font-bold text-blue-600">$<?php echo e(number_format($listing->price, 2)); ?></span>
                                <span class="text-sm text-gray-500 flex items-center">
                                    <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                    </svg>
                                    <?php echo e($listing->odometer ?? 'N/A'); ?> miles
                                </span>
                            </div>
...
<?php echo $__env->make('layouts.welcome', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u898351377/domains/360webcoders.com/public_html/kaymark/resources/views/welcome.blade.php ENDPATH**/ ?>