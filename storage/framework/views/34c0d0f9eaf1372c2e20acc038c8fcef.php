        ...
        <nav class="nav-menu">
            <ul>
                ...
                <li class="nav-item"
                    ...
                    data-step="1">
                    <a href="<?php echo e(route('dashboard.buyer')); ?>" class="nav-link tooltip active" data-tooltip="Dashboard">
                ...
                <li class="nav-item"
                    ...
                    data-step="2">
                    <a href="<?php echo e(route('profile.edit')); ?>" class="nav-link tooltip" data-tooltip="Account Profile">
                ...
                <li class="nav-item"
                    ...
                    data-step="3">
                    <a href="<?php echo e(route('buyer.purchases')); ?>" class="nav-link tooltip" data-tooltip="Past Purchases">
                ...
                <li class="nav-item"
                    ...
                    data-step="4">
                    <a href="<?php echo e(route('buyer.messages')); ?>" class="nav-link tooltip" data-tooltip="Messaging">
                ...
                <li class="nav-item"
                    ...
                    <ul class="submenu" id="bids-submenu">
                        <li class="submenu-item">
                            <a href="<?php echo e(route('buyer.bids')); ?>" class="submenu-link">Bids</a>
                        </li>
                        <li class="submenu-item">
                            <a href="<?php echo e(route('buyer.watchlist')); ?>" class="submenu-link">Watchlist</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="nav-item"
                    ...
                    data-step="6">
                    <a href="<?php echo e(route('buyer.escrow')); ?>" class="nav-link tooltip"
                ...
                <li class="nav-item"
                    ...
                    data-step="7">
                    <a href="<?php echo e(route('buyer.notifications')); ?>" class="nav-link tooltip" data-tooltip="Notifications">
...
<?php /**PATH /home/u898351377/domains/360webcoders.com/public_html/kaymark/resources/views/partials/buyerSidebar.blade.php ENDPATH**/ ?>