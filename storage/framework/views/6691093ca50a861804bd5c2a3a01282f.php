        ...
        <main class="container mx-auto px-4 py-6">
            ...
            <div class="mb-6 animate-fade-in">
                ...
                <div class="flex flex-col md:flex-row md:items-center justify-between">
                    <p class="text-sm text-secondary-500 mb-2 md:mb-0">
                        Showing results <?php echo e($auctions->firstItem()); ?> - <?php echo e($auctions->lastItem()); ?> of
                        <?php echo e($auctions->total()); ?>
            ...
            <div class="flex flex-col lg:flex-row gap-6">
                ...
                <aside class="w-full lg:w-1/4">
                    <form method="GET" action="<?php echo e(route('Auction.index')); ?>">
                        <div
                            ...
                            <div class="flex justify-between items-center mb-5">
                                ...
                                <a href="<?php echo e(route('Auction.index')); ?>"
                            ...
                            <div class="space-y-5 max-h-[70vh] overflow-y-auto filter-scroll pr-2">
                                    ...
                                    <div class="space-y-2 max-h-40 overflow-y-auto filter-scroll">
                                        <?php $__currentLoopData = $filterOptions['types']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <label class="flex items-center py-1 cursor-pointer group">
                                                <input type="checkbox" name="type[]" value="<?php echo e($type); ?>"
                                                    <?php if(in_array($type, request('type', []))): echo 'checked'; endif; ?>
                                                    class="rounded text-primary-600 focus:ring-primary-500 mr-2 transition-all group-hover:scale-110">
                                                <span
                                                    class="text-sm text-secondary-600 group-hover:text-secondary-800 transition-colors"><?php echo e($type); ?></span>
                                            </label>
                                    ...
                                    <div>
                                        ...
                                        <div class="space-y-2 max-h-40 overflow-y-auto filter-scroll">
                                            <?php $__currentLoopData = $filterOptions['makes']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $make): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <label class="flex items-center py-1 cursor-pointer group">
                                                    <input type="checkbox" name="makes[]" value="<?php echo e($make); ?>"
                                                        <?php if(in_array($make, request('makes', []))): echo 'checked'; endif; ?>
                                                        class="rounded text-primary-600 focus:ring-primary-500 mr-2 transition-all group-hover:scale-110">
                                                    <span
                                                        class="text-sm text-secondary-600 group-hover:text-secondary-800 transition-colors"><?php echo e($make); ?></span>
                                                </label>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="space-y-2 max-h-40 overflow-y-auto filter-scroll">
                                            <?php $__currentLoopData = $filterOptions['models']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $model): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <label class="flex items-center py-1 cursor-pointer group">
                                                    <input type="checkbox" name="models[]" value="<?php echo e($model); ?>"
                                                        <?php if(in_array($model, request('models', []))): echo 'checked'; endif; ?>
                                                        class="rounded text-primary-600 focus:ring-primary-500 mr-2 transition-all group-hover:scale-110">
                                                    <span
                                                        class="text-sm text-secondary-600 group-hover:text-secondary-800 transition-colors"><?php echo e($model); ?></span>
                                                </label>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>
                                    </div>
                                ...
                                <div class="filter-section">
                                    ...
                                    <div>
                                        <input type="text" placeholder="Search Locations..."
                                            class="w-full border rounded-lg p-2 mb-2 text-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all">
                                        <div class="space-y-2 max-h-40 overflow-y-auto filter-scroll">
                                            <?php $__currentLoopData = $filterOptions['locations']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <label class="flex items-center py-1 cursor-pointer group">
                                                    <input type="checkbox" name="locations[]" value="<?php echo e($location); ?>"
                                                        <?php if(in_array($location, request('locations', []))): echo 'checked'; endif; ?>
                                                        class="rounded text-primary-600 focus:ring-primary-500 mr-2 transition-all group-hover:scale-110">
                                                    <span
                                                        class="text-sm text-secondary-600 group-hover:text-secondary-800 transition-colors"><?php echo e($location); ?></span>
                                                </label>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>
                                    </div>
                                ...
                                <div class="filter-section">
                                    ...
                                    <div class="flex items-center space-x-2">
                                        <input type="number" name="year_from" value="<?php echo e(request('year_from')); ?>"
                                            placeholder="From"
                                            class="w-1/2 border rounded-lg p-2 text-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all">
                                        <input type="number" name="year_to" value="<?php echo e(request('year_to')); ?>"
                                            placeholder="To"
                                            class="w-1/2 border rounded-lg p-2 text-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all">
                                    </div>
                                </div>
                                ...
                                <div class="filter-section">
                                    ...
                                    <div class="flex items-center space-x-2">
                                        <input type="number" name="odo_min" value="<?php echo e(request('odo_min')); ?>"
                                            placeholder="Min"
                                            class="w-1/2 border rounded-lg p-2 text-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all">
                                        <input type="number" name="odo_max" value="<?php echo e(request('odo_max')); ?>"
                                            placeholder="Max"
                                            class="w-1/2 border rounded-lg p-2 text-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all">
                                    </div>
                                </div>
                                        ...
                                        <?php $__currentLoopData = $filterOptions['colors']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <label class="flex items-center py-1 cursor-pointer group">
                                                <input type="checkbox" name="colors[]" value="<?php echo e($color); ?>"
                                                    <?php if(in_array($color, request('colors', []))): echo 'checked'; endif; ?>
                                                    class="rounded text-primary-600 focus:ring-primary-500 mr-2 transition-all group-hover:scale-110">
                                                <span
                                                    class="text-sm text-secondary-600 group-hover:text-secondary-800 transition-colors"><?php echo e($color); ?></span>
                                            </label>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                </div>
                                        ...
                                        <?php $__currentLoopData = $filterOptions['primary_damage']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <label class="flex items-center py-1 cursor-pointer group">
                                                <input type="checkbox" name="primary_damage[]"
                                                    value="<?php echo e($pd); ?>" <?php if(in_array($pd, request('primary_damage', []))): echo 'checked'; endif; ?>
                                                    class="rounded text-primary-600 focus:ring-primary-500 mr-2 transition-all group-hover:scale-110">
                                                <span
                                                    class="text-sm text-secondary-600 group-hover:text-secondary-800 transition-colors"><?php echo e($pd); ?></span>
                                            </label>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                </div>
                                        ...
                                        <?php $__currentLoopData = $filterOptions['secondary_damage']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <label class="flex items-center py-1 cursor-pointer group">
                                                <input type="checkbox" name="secondary_damage[]"
                                                    value="<?php echo e($sd); ?>" <?php if(in_array($sd, request('secondary_damage', []))): echo 'checked'; endif; ?>
                                                    class="rounded text-primary-600 focus:ring-primary-500 mr-2 transition-all group-hover:scale-110">
                                                <span
                                                    class="text-sm text-secondary-600 group-hover:text-secondary-800 transition-colors"><?php echo e($sd); ?></span>
                                            </label>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                </div>
                                ...
                                <div class="filter-section">
                                    ...
                                    <div class="space-y-2 max-h-40 overflow-y-auto filter-scroll">
                                        <?php $__currentLoopData = $filterOptions['transmission']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <label class="flex items-center py-1 cursor-pointer group">
                                                <input type="checkbox" name="transmission[]" value="<?php echo e($tr); ?>"
                                                    <?php if(in_array($tr, request('transmission', []))): echo 'checked'; endif; ?>
                                                    class="rounded text-primary-600 focus:ring-primary-500 mr-2 transition-all group-hover:scale-110">
                                                <span
                                                    class="text-sm text-secondary-600 group-hover:text-secondary-800 transition-colors"><?php echo e($tr); ?></span>
                                            </label>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                </div>
                                        ...
                                        <?php $__currentLoopData = $filterOptions['title_status']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ts): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <label class="flex items-center py-1 cursor-pointer group">
                                                <input type="checkbox" name="title_condition[]"
                                                    value="<?php echo e($ts); ?>" <?php if(in_array($ts, request('title_condition', []))): echo 'checked'; endif; ?>
                                                    class="rounded text-primary-600 focus:ring-primary-500 mr-2 transition-all group-hover:scale-110">
                                                <span
                                                    class="text-sm text-secondary-600 group-hover:text-secondary-800 transition-colors"><?php echo e($ts); ?></span>
                                            </label>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                </div>
...
<section class="w-full lg:w-3/4">
                    ...
                    <div x-show="viewMode === 'grid'"
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $auctions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $listing): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div
                                ...
                                <div class="p-4 flex-1 flex flex-col">
                                    <h3 class="text-lg font-semibold text-secondary-800 mb-2 line-clamp-1">
                                        <?php echo e($listing->year); ?> <?php echo e($listing->make); ?> <?php echo e($listing->model); ?>
                                    ...
                                    <div class="grid grid-cols-2 gap-2 mb-4">
                                        <div class="flex items-center text-sm text-gray-600">
                                            ...
                                            <span><?php echo e($listing->odometer ? number_format($listing->odometer) . ' mi' : 'N/A'); ?></span>
                                        </div>
                                        <div class="flex items-center text-sm text-gray-600">
                                            <span class="material-icons text-gray-400 text-sm mr-1">location_on</span>
                                            <span class="truncate"><?php echo e($listing->location ?? 'N/A'); ?></span>
                                        </div>
                                        <div class="flex items-center text-sm text-gray-600">
                                        ...
                                        <div class="flex items-center text-sm text-gray-600">
                                            ...
                                            <span><?php echo $listing->sale_date ? \Carbon\Carbon::parse($listing->sale_date)->format('M d') : 'N/A'; ?></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mt-auto pt-3 border-t border-gray-200">
                                        ...
                                        <div class="flex justify-between items-center">
                                            <p class="text-xl font-bold text-green-600 price-tag">
                                                $<?php echo e(number_format($listing->current_bid ?? 0)); ?>

                                            </p>
                                            <?php if(Auth::check()): ?>
                                                <a href="<?php echo e(route('auction.show', $listing->id)); ?>"
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $auctions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $listing): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div
                                ...
                                <div class="md:w-2/5 relative image-container">
                                    ...
                                    ?>
                                    <img alt="<?php echo e($listing->title ?? $listing->make . ' ' . $listing->model); ?>"
                                        style="height:250px" src="<?php echo e($imgUrl); ?>"
                                    ...
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-2">
                                        <div class="flex items-center">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-sm font-medium">
                                                    <?php echo e($listing->odometer ? number_format($listing->odometer) . ' miles' : 'N/A'); ?>
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-sm font-medium"><?php echo e($listing->location ?? 'N/A'); ?></p>
                                            </div>
                                        </div>
                                        <div class="flex items-center">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-sm font-medium">
                                                    <?php echo e($listing->sale_date ? \Carbon\Carbon::parse($listing->sale_date)->format('M d, Y') : 'N/A'); ?>
                                    ...
                                    <div class="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm text-gray-600">
                                        ...
                                        <?php if($listing->transmission): ?>
                                            <div class="flex"><span class="font-medium mr-1">Transmission:</span>
                                                <span><?php echo e($listing->transmission); ?></span>
                                            </div>
                                        <?php endif; ?>
                                        <?php if($listing->color): ?>
                                            <div class="flex"><span class="font-medium mr-1">Color:</span>
                                                <span><?php echo e($listing->color); ?></span>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                    ...
                    <div class="mt-8 flex justify-center animate-fade-in">
                        <?php echo e($auctions->links('pagination::tailwind')); ?>
...
<?php echo $__env->make('layouts.welcome', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u898351377/domains/360webcoders.com/public_html/kaymark/resources/views/auction.blade.php ENDPATH**/ ?>