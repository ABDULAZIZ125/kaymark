        ...
        <div class="bg-white p-5 rounded-xl shadow-sm border border-gray-100">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-800"><?php echo e($listings->total()); ?></p>
                </div>
            </div>
        </div>
            ...
            <div class="bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-100 flex flex-col h-full">
                ...
                <div class="relative">
                    <img src="<?php echo e($mainImage); ?>"
                         alt="<?php echo e($listing->make); ?> <?php echo e($listing->model); ?>"
                    ...
                    <div class="absolute bottom-0 left-0 right-0 bg-black bg-opacity-40 text-white p-2 text-xs">
                        <div class="flex justify-between mb-1">
                            <span>Ends: <?php echo e($endDate->format('M d, Y')); ?></span>
                            <span><?php echo e($timeRemaining); ?></span>
                        </div>
                        <?php
                        ...
                        <div class="w-full bg-gray-200 rounded-full h-1.5">
                            <div class="bg-green-500 h-1.5 rounded-full" style="width: <?php echo e($percentage); ?>%"></div>
                        </div>
                    </div>
                    <?php endif; ?>
                </div>
                ...
                <div class="p-5 flex-grow">
                    ...
                    <div class="flex items-center text-sm text-gray-600 mb-3">
                        ...
                        <span>Listed: <?php echo e($listing->created_at->format('M d, Y')); ?></span>
                    </div>
                    ...
                    <div class="mb-4 p-3 bg-gray-50 rounded-lg">
                        <div class="flex justify-between items-center mb-1">
                            ...
                            <span class="text-lg font-bold text-primary-DEFAULT">$<?php echo e(number_format($highestBid, 2)); ?></span>
                        </div>
                        <div class="text-xs text-gray-500">
                            <?php echo e($listing->bids->count()); ?> <?php echo e(Str::plural('bid', $listing->bids->count())); ?> placed
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.Seller', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u898351377/domains/360webcoders.com/public_html/kaymark/resources/views/Seller/Auction/index.blade.php ENDPATH**/ ?>