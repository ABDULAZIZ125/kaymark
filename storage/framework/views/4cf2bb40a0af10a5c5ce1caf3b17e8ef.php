    ...
    <div class="container mx-auto px-4 py-12 max-w-6xl">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="plan-card bg-white rounded-xl p-8 border-t-blue-500 shadow-md">
                ...
                <a href="<?php echo e(route('subscription.simulate', ['plan' => 'basic'])); ?>"
            ...
            <div class="plan-card bg-white rounded-xl p-8 border-t-purple-500 shadow-md relative">
                ...
                <a href="<?php echo e(route('subscription.simulate', ['plan' => 'premium'])); ?>"
...
<?php /**PATH /home/u898351377/domains/360webcoders.com/public_html/kaymark/resources/views/subscription/seller_plans.blade.php ENDPATH**/ ?>