...
<aside class="sidebar">
    ...
    <a href="<?php echo e(route('profile.edit')); ?>">
        <div class="user-profile">
            ...
            <h2 class="user-name"><?php echo e(Str::ucfirst(Auth::user()->name)); ?></h2>
        ...
        <ul class="nav flex flex-col space-y-2">
            <li class="nav-item">
                <a href="<?php echo e(route('admin.dashboard')); ?>" 
                   class="nav-link tooltip <?php echo e(str_contains($currentRoute, 'dashboard') ? 'active' : ''); ?>" 
            ...
            <li class="nav-item">
                <a href="<?php echo e(route('admin.users')); ?>" 
                   class="nav-link tooltip <?php echo e(str_contains($currentRoute, 'users') ? 'active' : ''); ?>" 
            ...
            <li class="nav-item">
                <a href="<?php echo e(route('admin.subscriptions')); ?>" 
                   class="nav-link tooltip <?php echo e(str_contains($currentRoute, 'memberships') ? 'active' : ''); ?>" 
            ...
            <li class="nav-item">
                <a href="<?php echo e(route('admin.show.listing')); ?>" 
                   class="nav-link tooltip <?php echo e(str_contains($currentRoute, 'listing-review') ? 'active' : ''); ?>" 
            ...
            <li class="nav-item">
                <a href="<?php echo e(route('admin.active-listings')); ?>" 
                   class="nav-link tooltip <?php echo e(str_contains($currentRoute, 'active-listings') ? 'active' : ''); ?>" 
            ...
            <li class="nav-item">
                <a href="<?php echo e(route('admin.boosts-addons')); ?>" 
                   class="nav-link tooltip <?php echo e(str_contains($currentRoute, 'boosts-addons') ? 'active' : ''); ?>" 
            ...
            <li class="nav-item">
                <a href="<?php echo e(route('admin.payments')); ?>" 
                   class="nav-link tooltip <?php echo e(str_contains($currentRoute, 'payments') ? 'active' : ''); ?>" 
            ...
            <li class="nav-item">
                <a href="<?php echo e(route('admin.disputes')); ?>" 
                   class="nav-link tooltip <?php echo e(str_contains($currentRoute, 'disputes') ? 'active' : ''); ?>" 
            ...
            <li class="nav-item">
                <a href="<?php echo e(route('admin.notifications')); ?>" 
                   class="nav-link tooltip <?php echo e(str_contains($currentRoute, 'notifications') ? 'active' : ''); ?>" 
            ...
            <li class="nav-item">
                <a href="<?php echo e(route('admin.reports-analytics')); ?>" 
                   class="nav-link tooltip <?php echo e(str_contains($currentRoute, 'reports-analytics') ? 'active' : ''); ?>" 
...
<?php /**PATH /home/u898351377/domains/360webcoders.com/public_html/kaymark/resources/views/partials/adminSidebar.blade.php ENDPATH**/ ?>