...
.no-conversations {
    ...
    <?php $__empty_1 = true; $__currentLoopData = $chats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        ...
        <a href="<?php echo e(route('seller.chat', $chat->id)); ?>"
           class="conversation-item <?php echo e(isset($activeChat) && $chat->id === $activeChat->id ? 'active' : ''); ?>"
           data-chat-id="<?php echo e($chat->id); ?>">
            <!-- Avatar -->
            <div class="avatar buyer <?php echo e(isset($otherUser->online) && $otherUser->online ? 'online' : ''); ?>">
                <?php echo e(isset($otherUser->name) ? strtoupper(substr($otherUser->name, 0, 2)) : 'U'); ?>

            </div>

            <!-- Info -->
            <div class="conversation-info">
                <h3><?php echo e($otherUser->name ?? 'Unknown User'); ?></h3>
                <p class="message-preview">
                    <?php echo e(\Illuminate\Support\Str::limit($lastMessage->message ?? 'No messages yet', 40)); ?>
            ...
            <div class="conversation-meta">
                <div class="time"><?php echo e($lastMessage?->created_at?->format('h:i A')); ?></div>
                <?php if($unreadCount > 0): ?>
                    <div class="unread-count"><?php echo e($unreadCount); ?></div>
                <?php endif; ?>
            </div>
        </a>
    ...
    <?php endif; ?>
                    ...
                    <div class="chat-area">
                        ...
                        <div class="chat-header">
                            <div class="chat-user-info">
                                ...
                                <div class="user-details">
                                    <h2>
                                        <?php if($activeChat): ?>
                                            <?php echo e(auth()->id() === $activeChat->buyer_id ? $activeChat->seller->name : $activeChat->buyer->name); ?>
                                    ...
                                    <p>
                                        <?php if($activeChat): ?>
                                            Online • <?php echo e($activeChat->listing->title ?? 'No listing info'); ?>
                        ...
                        <div class="messages-container" id="messagesContainer">
                            <?php if($activeChat): ?>
                                <?php $__currentLoopData = $activeChat->messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                        $side = $message->sender_id === auth()->id() ? 'seller' : 'buyer';
                                    ?>
                                    <div class="message <?php echo e($side); ?>" data-msg-id="<?php echo e($message->id); ?>">
                        ...
                        <div class="input-area">
                            ...
                            <input type="text" class="message-input" id="messageInput" placeholder="Type your message..."
                                autocomplete="off" <?php if(!$activeChat): ?> disabled <?php endif; ?>>
                            <button class="icon-btn send-btn" id="sendBtn"
                                <?php if(!$activeChat): ?> disabled <?php endif; ?>>
...
<script>
    // server-side state
    const chatId = <?php echo json_encode($chatId ?? null, 15, 512) ?>;
    ...
    const sendSoundSrc = "<?php echo e(asset('sounds/send.mp3')); ?>";
    const receiveSoundSrc = "<?php echo e(asset('sounds/receive.mp3')); ?>";
    ...
    async function sendMessageToServer(chatIdLocal, messageText) {
        ...
        const baseUrl = "<?php echo e(url('/seller/Seller_Chat')); ?>"; // keep same as your routes or change to buyer route
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        try {
            ...
            window.Echo = new Echo({
                ...
                cluster: '<?php echo e(config("broadcasting.connections.pusher.options.cluster") ?? (env("PUSHER_APP_CLUSTER") ?? "")); ?>',
                forceTLS: true,
                auth: {
                    headers: {
...
<?php echo $__env->make('layouts.Seller', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u898351377/domains/360webcoders.com/public_html/kaymark/resources/views/Seller/Sellerchat.blade.php ENDPATH**/ ?>